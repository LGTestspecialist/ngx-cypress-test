...
describe('Walter Living TC9', () => {
    ...
    it('should navigate to the loging page', () => {
        ...
        // Type the following address in the search for address field at the top of the page: Volgerweg 18 Middenbeemster (every test use a different adress for  now)
        cy.get('#report_search_query').type('Volgerweg 18 Middenbeemster')

        // Click on the first address suggestion (PVolgerweg 18 Middenbeemster)
